...
representative_dataset_gen = get_representative_dataset('C:/GIT/val_data_imagenet', n_iter=20, reshuffle_dir = True, reshuffle_gen = False, wrap_res_list=True, do_unsqueeze = True)
...
mct.exporter.pytorch_export_model(quantized_model, save_model_path=f'q-{type(model).__name__}.onnx', repr_dataset=representative_dataset_gen)
